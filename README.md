...
## 3. Meaning
    ...
    기존에 Javascript를 안다고 자만했던 제 자신을 반성하며 앱 개발이 이렇게 힘들다는것을 몸소 느끼게 되었습니다.

    이번 채팅앱은 정말 힘들게 만든만큼 배포까지가 목표였습니다. (IOS 개발자등록 1년에 $100, 구글 개발자 등록 $25 결재완료... ㅠ ㅠ가격 엄청나다...)
    하지만 커뮤니티앱을 올리는만큼 여러가지 문제가 많이 생길것같아 (관리적인 부분, 폭력, 음란물 차단기능 사실상 미존재..) 배포는 하지 않게되었습니다.
